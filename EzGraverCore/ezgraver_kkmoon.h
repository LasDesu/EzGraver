#ifndef EZGRAVER_KKMOON_H
#define EZGRAVER_KKMOON_H
...
struct EzGraverKKmoon : EzGraver {
	 ...
	 */
	void start(unsigned char depth, unsigned char power) override;
...
private:
	void _sendCommand(uint8_t cmd, QByteArray const& data);
};
